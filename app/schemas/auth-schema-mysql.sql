...
CREATE TABLE IF NOT EXISTS `%sroles_users` (
  ...
  CONSTRAINT `%sroles_users_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `%susers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `%sroles_users_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `%sroles` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `%suser_tokens` (
  ...
  CONSTRAINT `%suser_tokens_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `%susers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
