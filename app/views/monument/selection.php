			<form method="get" action="" id="<?php echo $formname; ?>">
				...
				<select id="provinces" name="province">
					...
					foreach($provinces AS $province) {
						echo '<option value="'.$province->id_province.'"'; if ($param['province'] == $province->id_province) { echo ' selected="selected"'; } echo '>'.$province->name.'</option>';
					}
					?>
				</select>
