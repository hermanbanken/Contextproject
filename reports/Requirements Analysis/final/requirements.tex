...
\section{Voorgesteld systeem}
	\subsection{Overzicht}
		...
		\subsection{Functional requirements}	
			...
			Op de detail pagina zal een weersverwachting staan van de omgeving rond de locatie van het betreffende monument. Deze weersverwachting halen we op d.m.v. de api van wunderground.com waar we de longitude en latitude aan meegeven.
				
			\subsubsection{Faciliteiten rond locatie}
			Op de detail pagina zal de optie zijn faciliteiten rond het betreffende monument op het kaartje te weergeven. 
