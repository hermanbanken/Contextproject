...
\section{Voorgesteld systeem}
	...
	\subsection{Functional requirements}
		\subsubsection{Selectiecriteria}
			\begin{enumerate}
			\item \textbf{Een gebruiker moet aan de hand van de volgende selectiecriteria de verzameling getoonde monumenten op de kaart kunnen beperken en specificeren:}\\
			\\
			...
			\item \textbf{De gebruiker moet bij het aanklikken van een monument de detailpagina van het betreffende monument te zien krijgen. Deze detailpagina zal de volgende items bevatten.}\\
			\\
