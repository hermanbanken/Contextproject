...
\section{Voorgesteld systeem}
	\subsection{Overzicht}
		...
		\subsection{Functional requirements}	
			...
			Een subset van de dataset is niet gecategoriseerd. Aan de hand van visuele gelijkenissen en tekstanalyse van de beschrijvingen gaan we de categorie\"en aanvullen. 
				
			\subsubsection{Foursquare}
			Voor ieder van de ~22.500 monumenten gaan we locaties aanmaken op FourSquare. Mensen kunnen inchecken bij deze locaties. Aan de hand van de hoeveelheid check-ins bij de lokaties kunnen we populariteit van de monumenten nagaan. Niet alleen gebruikers van het systeem kunnen inchecken, ook mensen die nooit het systeem gebruiken. Hierdoor wordt de data verreikt met informatie van mensen zonder dat zij hier bewust aan meewerken. 
